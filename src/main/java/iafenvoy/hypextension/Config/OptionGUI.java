...
public class OptionGUI extends GuiBase {
  ...
  public void initGui() {
    ...
    for (int i = 0; i < INSTANCE.size(); i++) {
      ...
      ButtonGeneric button2 = button.createButton();
      button.setLocation((i % l) * 135 + 10, (i / l) * 25 + 60, 130, 20);
  ...
  public static class OptionButton {
    ...
    public ButtonGeneric createButton() {
      button = new Button(0, 0, 0, 0, StringUtils.translate(translateKey));
      setDisplayString();
      return button;
    }
    ...
    public void setLocation(int x, int y, int width, int height) {
      if (button != null)
        button.setLocation(x, y, width, height);
    }
